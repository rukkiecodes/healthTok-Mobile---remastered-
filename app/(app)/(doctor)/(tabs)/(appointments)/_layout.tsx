...
export default function _layout () {
  ...
  return (
    <PaperProvider>
      ...
      >
        <HapticWrapper
          onPress={() => router.navigate('/(app)/(doctor)/(tabs)/(appointments)/upcoming')}
          style={{
        ...
        <HapticWrapper
          onPress={() => router.navigate('/(app)/(doctor)/(tabs)/(appointments)/completed')}
          style={{
        ...
        <HapticWrapper
          onPress={() => router.navigate('/(app)/(doctor)/(tabs)/(appointments)/canceled')}
          style={{
