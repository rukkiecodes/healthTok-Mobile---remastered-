    ...
    <PaperProvider>
      ...
      >
        ...
        <TouchableOpacity
          onPress={() => {
            router.push({
              pathname: '/(app)/(split)/(doctor)/(chats)/addPresriptions',
      ...
      >
        <HapticWrapper
          onPress={() => {
            router.push({
              pathname: '/(app)/(split)/(doctor)/(chats)/(prescription)/sent',
        ...
        <HapticWrapper
          onPress={() => {
            router.push({
              pathname: '/(app)/(split)/(doctor)/(chats)/(prescription)/injectables',
              params: { chatId: String(chatId), conversationData: conversationData }
            })
          }}
          style={{
        ...
        <HapticWrapper
          onPress={() => {
            router.push({
              pathname: '/(app)/(split)/(doctor)/(chats)/(prescription)/orals',
              params: { chatId: String(chatId), conversationData: conversationData }
            })
          }}
          style={{
